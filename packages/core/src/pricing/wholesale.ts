...
/**
 * 심리가격 변환: 1,000원 올림 후, 만원 경계(10,000·20,000·30,000…)에만 -100원
 *
 * 이유: 20,000→19,900은 "2만원대→1만원대"로 체감이 달라지지만
 *       26,000→25,900은 어차피 "2만원대"라 의미 없음
 *
 * 예시:
 *   19,230 → ceil(20,000) → 만원 경계 → 19,900원
 *   25,036 → ceil(26,000) → 경계 아님 → 26,000원
 *   9,500  → ceil(10,000) → 만원 경계 → 9,900원
 *   6,100  → ceil(7,000)  → 경계 아님 → 7,000원
 */
