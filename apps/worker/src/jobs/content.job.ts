...
import { generateProductDescription, optimizeProductTitle, generateSearchTags } from '@smartstore/core'
    ...
    async (job: Job<ContentJobData>) => {
      ...
      try {
        ...
        if (searchTags.length > 0) {
          logger.info('search_tags_generated', {
            productId,
            tags: searchTags,
          })
        }
